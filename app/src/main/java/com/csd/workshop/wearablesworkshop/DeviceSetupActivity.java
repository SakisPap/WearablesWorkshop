package com.csd.workshop.wearablesworkshop;
...
public class DeviceSetupActivity extends AppCompatActivity implements ServiceConnection, DeviceSetupActivityFragment.FragmentSettings {
    public final static String EXTRA_BT_DEVICE= "com.csd.workshop.wearablesworkshop.DeviceSetupActivity.EXTRA_BT_DEVICE";

    public static class ReconnectDialogFragment extends DialogFragment implements  ServiceConnection {
        private static final String KEY_BLUETOOTH_DEVICE = "com.csd.workshop.wearablesworkshop.DeviceSetupActivity.ReconnectDialogFragment.KEY_BLUETOOTH_DEVICE";
